# Graph Report - my_app  (2026-09-08)

## Corpus Check
- 378 files · ~1,979,147 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3433 nodes · 6164 edges · 286 communities (173 shown, 113 thin omitted)
...
- interny-app/screens/TrackerScreen.js
- tsconfig.json
...
- marker.tsx
- interny-site-review/components/ui/field.tsx
- expo-calendar
...
- interny-site-review/components/ui/context-menu.tsx
...
- ignorePatterns
- interny-site-review/components/ui/navigation-menu.tsx
...
- interny-site-review/components/ui/toggle-group.tsx
- interny-site-review/components/ui/alert.tsx
- Interny site parity assessment — 2026-09-08
- interny-site-review/components/ui/marker.tsx
...
- interny-site/components/ui/toast.tsx
...
3. `useUser()` - 40 edges
4. `useUser()` - 37 edges
5. `computeMatchBreakdown()` - 30 edges
6. `computeMatchBreakdown()` - 24 edges
7. `computeMatchBreakdown()` - 24 edges
8. `getEffectiveDaysLeft()` - 23 edges
9. `getEffectiveDaysLeft()` - 23 edges
10. `getEffectiveDaysLeft()` - 23 edges
...
- `ReviewPromptModal()` --calls--> `useUser()`  [EXTRACTED]
  components/ReviewPromptModal.js → context/UserContext.js
...
## Communities (286 total, 113 thin omitted)
...
Cohesion: 0.09
Nodes (49): CITY_COORDS, ADJACENCY_GROUPS, ageFitLevel(), ALL_STATE_ABBREVS, CITY_TO_STATE, computeMatchBreakdown(), computeMatchReasons(), describeLocationEntry() (+41 more)
...
### Community 16 - "interny-app/screens/TrackerScreen.js"
Cohesion: 0.06
Nodes (39): ClosedBadge(), CompanyLogo(), DeadlineBadge(), Divider(), MatchBreakdownModal(), mbStyles, PremiumTourOverlay(), styles (+31 more)
...
Cohesion: 0.10
Nodes (31): ReviewPromptModal(), ACTIVE_STATUSES, DEFAULT_USER, makeId(), ONBOARDING_VERSION, NOTE: keep the setApplicationMap call OUTSIDE the setSavedIds updater,, STATUS_META, STATUSES (+23 more)
...
Cohesion: 0.12
Nodes (17): dependencies, expo, expo-constants, expo-document-picker, expo-font, expo-notifications, react-native, react-native-safe-area-context (+9 more)
...
Cohesion: 0.07
Nodes (49): ADJACENCY_GROUPS, ageFitLevel(), ageFromBirthday(), ALL_STATE_ABBREVS, CITY_TO_STATE, describeLocationEntry(), detectGenderRequirement(), detectPayType() (+41 more)

### Community 62 - "interny-site/lib/utils.ts"
Cohesion: 0.06
Nodes (19): AspectRatio(), Badge(), badgeVariants, ButtonGroup(), ButtonGroupSeparator(), ButtonGroupText(), buttonGroupVariants, Checkbox() (+11 more)
...
Cohesion: 0.07
Nodes (58): buildDailyPickReason(), CITY_COORDS, ADJACENCY_GROUPS, ageFitLevel(), ALL_STATE_ABBREVS, CITY_TO_STATE, computeDaysLeft(), computeMatchBreakdown() (+50 more)

### Community 72 - "interny-site/components/ui/alert-dialog.tsx"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (46): App(), CatalogStatus(), ErrorBoundary, navigateToInternship(), parseInternshipIdFromUrl(), NOTE: no hardcoded height/paddingBottom, because overriding them, NOTE: loadInternships / subscribeToInternships are handled in App() below, RootNavigator() (+38 more)
...
### Community 81 - "cn"
Cohesion: 0.05
Nodes (62): Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), Breadcrumb(), BreadcrumbEllipsis() (+54 more)
...
Cohesion: 0.12
Nodes (17): useTourTarget(), ChecklistCard(), DETAIL_TABS, DetailScreen(), _FALLBACK_STATUS_META, _FALLBACK_STATUSES, matchColors(), matchLabel() (+9 more)
...
Cohesion: 0.18
Nodes (14): { height: SCREEN_H }, IDLE, sleep(), TourActionsContext, TourProvider(), TourStateContext, useUser(), buildFeatureTourSteps() (+6 more)
...
Cohesion: 0.06
Nodes (31): BIRTHDAY_DEFAULT, BIRTHDAY_MAX, BIRTHDAY_MIN, birthdayToISO(), FORMAT_OPTIONS, formatBirthday(), GENDER_OPTIONS, GPA_OPTIONS (+23 more)
...
Cohesion: 0.07
Nodes (34): EssayReviewScreen(), styles, AGE_OPTIONS, ALL_INTERESTS, computeProfileStrength(), EditProfileModal(), extractStateAbbrev(), FORMAT_PREF_OPTIONS (+26 more)
...
### Community 139 - "phone-scene.tsx"
Cohesion: 0.18
Nodes (7): chapters, screens, files, opening, PhoneScene(), Pose, poses
...
### Community 147 - "toggle-group.tsx"
Cohesion: 0.43
...
### Community 153 - "interny-site-review/components/ui/field.tsx"
Cohesion: 0.07
...
Cohesion: 0.09
Nodes (32): TodaysPickCard(), SavedCard(), SimilarCard(), buildStateRegex(), CategoryCard, CheckboxRow, COMPETITIVENESS_OPTIONS, dpStyles (+24 more)
...
### Community 159 - "interny-app/screens/HomeScreen.js"
Cohesion: 0.14
Nodes (20): { height: SCREEN_H }, IDLE, sleep(), TourActionsContext, TourProvider(), TourStateContext, useTourTarget(), BehaviorCard() (+12 more)
...
Cohesion: 0.07
Nodes (29): devDependencies, @cloudflare/vite-plugin, @cloudflare/workers-types, oxfmt, oxlint, oxlint-tsgolint, tailwindcss, @types/node (+21 more)
...
Cohesion: 0.13
Nodes (13): benefits, chapters, faqs, screens, files, opening, PhoneScene(), Pose (+5 more)

### Community 170 - "interny-site-review/components/ui/context-menu.tsx"
Cohesion: 0.12
Nodes (9): ContextMenuCheckboxItem(), ContextMenuContent(), ContextMenuItem(), ContextMenuLabel(), ContextMenuRadioItem(), ContextMenuSeparator(), ContextMenuShortcut(), ContextMenuSubTrigger() (+1 more)
...
### Community 179 - "interny-site-review/components/ui/navigation-menu.tsx"
Cohesion: 0.22
Nodes (9): NavigationMenu(), NavigationMenuContent(), NavigationMenuIndicator(), NavigationMenuItem(), NavigationMenuLink(), NavigationMenuList(), NavigationMenuPositioner(), NavigationMenuTrigger() (+1 more)
...
### Community 184 - "interny-site-review/components/ui/toggle-group.tsx"
Cohesion: 0.43
Nodes (5): ToggleGroup(), ToggleGroupContext, ToggleGroupItem(), Toggle(), toggleVariants
...
### Community 187 - "interny-site-review/components/ui/marker.tsx"
Cohesion: 0.50
Nodes (4): Marker(), MarkerContent(), MarkerIcon(), markerVariants
...
Cohesion: 0.12
Nodes (17): dependencies, expo-constants, expo-document-picker, expo-font, expo-notifications, posthog-react-native, react-native, react-native-safe-area-context (+9 more)
...
### Community 219 - "interny-site/components/ui/toast.tsx"
Cohesion: 0.15
...
- **Why does `cn()` connect `cn` to `interny-site-review/components/ui/sidebar.tsx`, `interny-site-review/lib/utils.ts`, `interny-site-review/components/ui/button.tsx`, `interny-site-review/components/ui/field.tsx`, `interny-site-review/components/ui/menubar.tsx`, `interny-site-review/components/ui/combobox.tsx`, `interny-site-review/components/ui/command.tsx`, `interny-site-review/app/page.tsx`, `interny-site-review/components/ui/context-menu.tsx`, `interny-site-review/components/ui/drawer.tsx`, `interny-site-review/components/ui/carousel.tsx`, `interny-site-review/components/ui/alert-dialog.tsx`, `interny-site-review/components/ui/chart.tsx`, `interny-site-review/components/ui/attachment.tsx`, `interny-site-review/components/ui/navigation-menu.tsx`, `interny-site-review/components/ui/empty.tsx`, `interny-site-review/components/ui/bubble.tsx`, `interny-site-review/components/ui/toggle-group.tsx`, `interny-site-review/components/ui/alert.tsx`, `interny-site-review/components/ui/marker.tsx`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `expo` connect `expo` to `permissions`, `notification`, `splash`, `extra`, `plugins`, `ios`?**
