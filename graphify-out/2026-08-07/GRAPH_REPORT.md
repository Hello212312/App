...
## Corpus Check
- 78 files · ~107,444 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 633 nodes · 1230 edges · 55 communities (40 shown, 15 thin omitted)
...
Cohesion: 0.22
Nodes (11): styles, styles, styles, styles, styles, Colors, Radii, Shadows (+3 more)
...
Cohesion: 0.07
Nodes (30): ClosedBadge(), Divider(), MatchBreakdownModal(), mbStyles, SectionHeader(), styles, Tag(), { height: SCREEN_H } (+22 more)
...
Cohesion: 0.29
Nodes (9): APPLICATION_STATUSES, DECIDED_STATUSES, INTERNSHIPS, COLUMNS, getLiveDaysLeft(), PipelineCard(), StatsHeader(), styles (+1 more)

### Community 8 - "SearchScreen.js"
Cohesion: 0.07
Nodes (47): _listeners, loadInternships(), _notify(), refreshInternships(), rowToInternship(), subscribeToInternships(), BehaviorCard(), buildDailyPickReason() (+39 more)
...
### Community 39 - "App.js"
Cohesion: 0.13
Nodes (13): App(), ErrorBoundary, navigateToInternship(), parseInternshipIdFromUrl(), NOTE: no hardcoded height/paddingBottom — overriding them prevents, NOTE: loadInternships / subscribeToInternships are handled in App() below, RootNavigator(), Stack (+5 more)
...
Cohesion: 0.18
Nodes (15): useUser(), react, react, AppPickerModal(), ESSAY_QUESTIONS, KIND_COLORS, MATERIAL_KINDS, MaterialCard() (+7 more)

### Community 52 - "DeadlinesScreen.js"
Cohesion: 0.22
Nodes (7): CompanyLogo(), BUCKET_COLORS, BUCKET_LABELS, BUCKET_ORDER, bucketFor(), DeadlinesScreen(), styles

### Community 53 - "SavedScreen.js"
Cohesion: 0.40
Nodes (4): DeadlineBadge(), IN_PROGRESS_STATUSES, SavedScreen(), styles
...
- **Why does `useUser()` connect `useUser` to `theme.js`, `DetailScreen.js`, `ProfileScreen.js`, `matching.js`, `App.js`, `SearchScreen.js`, `OnboardingScreen.js`, `TrackerScreen.js`, `ChatScreen.js`, `InterviewPrepScreen.js`, `DeadlinesScreen.js`, `SavedScreen.js`, `UserContext.js`?**
