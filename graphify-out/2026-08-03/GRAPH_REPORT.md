# Graph Report - my_app  (2026-08-03)

## Corpus Check
- 77 files · ~107,260 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 633 nodes · 1228 edges · 68 communities (37 shown, 31 thin omitted)
...
- `ReviewPromptModal()` --calls--> `openStoreReview()`  [EXTRACTED]
  components/ReviewPromptModal.js → utils/review.js
...
### Community 0 - "App.js"
Cohesion: 0.06
Nodes (50): App(), ErrorBoundary, navigateToInternship(), parseInternshipIdFromUrl(), NOTE: no hardcoded height/paddingBottom — overriding them prevents, NOTE: loadInternships / subscribeToInternships are handled in App() below, RootNavigator(), Stack (+42 more)
...
Cohesion: 0.10
Nodes (19): ClosedBadge(), Divider(), MatchBreakdownModal(), mbStyles, SectionHeader(), styles, Tag(), DETAIL_TABS (+11 more)
...
Cohesion: 0.07
Nodes (37): useTourTarget(), EssayReviewScreen(), AGE_OPTIONS, ALL_INTERESTS, computeProfileStrength(), EditProfileModal(), extractStateAbbrev(), GENDER_OPTIONS (+29 more)

### Community 5 - "matching.js"
Cohesion: 0.09
Nodes (50): ChecklistCard(), ADJACENCY_GROUPS, ageFitLevel(), ALL_STATE_ABBREVS, CITY_TO_STATE, computeMatchBreakdown(), computeMatchReasons(), computeSimilarityScore() (+42 more)

### Community 6 - "package.json"
Cohesion: 0.22
Nodes (8): license, main, private, scripts, android, ios, start, web

### Community 7 - "HomeScreen.js"
Cohesion: 0.11
Nodes (30): DeadlineBadge(), APPLICATION_STATUSES, DECIDED_STATUSES, _listeners, loadInternships(), _notify(), refreshInternships(), rowToInternship() (+22 more)
...
Cohesion: 0.09
Nodes (14): AGES, GENDER_OPTIONS, GPA_OPTIONS, GRADES, HOUSING_OPTIONS, INTERESTS, PRIORITY_FACTORS, PRIORITY_LEVELS (+6 more)

### Community 10 - "TourContext.js"
Cohesion: 0.13
Nodes (15): PremiumTourOverlay(), styles, { width: SCREEN_W, height: SCREEN_H }, { height: SCREEN_H }, IDLE, sleep(), TourActionsContext, TourProvider() (+7 more)
...
Cohesion: 0.13
Nodes (15): expo, expo-document-picker, expo-store-review, dependencies, expo, expo-document-picker, expo-store-review, react-native-purchases (+7 more)
...
Cohesion: 0.11
Nodes (28): ACTIVE_STATUSES, DEFAULT_USER, makeId(), NOTE: keep the setApplicationMap call OUTSIDE the setSavedIds updater —, STATUS_META, STATUSES, UserContext, UserProvider() (+20 more)
...
## Knowledge Gaps
- **226 isolated node(s):** `Stack`, `Tab`, `TAB_ICONS`, `name`, `slug` (+221 more)
...
- **What is the exact relationship between `app/_layout.tsx` and `React Logo (2x) Image Asset`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `dependencies` connect `dependencies` to `App.js`, `@react-navigation/native`, `@react-navigation/stack`, `@supabase/supabase-js`, `package.json`, `expo-calendar`, `expo-clipboard`, `expo-dev-client`, `expo-file-system`, `expo-linking`, `expo-notifications`, `expo-status-bar`, `expo-video`, `react-native`, `@react-native-async-storage/async-storage`, `@react-native-community/datetimepicker`, `react-native-gesture-handler`, `react-native-screens`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `react` connect `App.js` to `dependencies`, `ProfileScreen.js`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `useUser()` connect `App.js` to `DetailScreen.js`, `ProfileScreen.js`, `matching.js`, `HomeScreen.js`, `SearchScreen.js`, `OnboardingScreen.js`, `TourContext.js`, `ChatScreen.js`, `InterviewPrepScreen.js`, `UserContext.js`?**
