...
import { ageFromBirthday, getProfileCoverage, isValidState } from '../utils/matching';
...
export default function ProfileScreen({ navigation }) {
 ...
 <Text style={styles.strengthTitle}>Profile completeness</Text>
 <Text style={[
 ...
 : strength < 70
 ? 'Confirm your home location and practical limits to complete your profile.'
 : 'Your basic preferences are complete. Check each program’s requirements before applying.'}
 </Text>
 ...
 activeOpacity={0.85}
 >
 <Text style={styles.strengthEditBtnText}>Complete preferences</Text>
 </TouchableOpacity>
 )}
 </View>
 );
 ...
 sublabel="Tell me when an internship I haven't saved is a confirmed preference fit (70%+) and closing soon"
 toggle
 ...
 sublabel="Tell me when a newly added internship in my field is a confirmed preference fit (70%+)"
 toggle
 ...
 <ProfileExtras visible={extrasVisible} onClose={() => setExtrasVisible(false)} />
 ...
 current={user.state}
 onSelect={(abbr) => {setState(abbr);setUser({state:abbr,location:[user.city,abbr].filter(Boolean).join(', '),locationConfirmed:false,locationSource:'home'});}}
